...
For advanced CI/CD scaling, advanced mocking strategies, and custom reporting, see `reference/jest-advanced.md`:

| Section | What's Inside |
|---------|--------------|
| §1 Scale & Sharding | Sharding tests, bailing, dynamic parallel workers |
| §2 Advanced Mocking | ES6 dynamic factories, class prototype spy |
| §3 Async Matchers | Custom async matchers and database validation |
| §4 Nested Matchers | Asymmetric validations for complex shapes |
| §5 Custom Reporters | Output formatting and granular coverage rules |
