  ...
  return (
    <button
      ...
      className="relative px-4 py-2 bg-blue-600 text-white
        rounded-lg overflow-hidden disabled:opacity-70"
    >
  ...
  return (
    <div className="relative">
      <input
        ...
        className="peer w-full px-4 py-3 border border-border
          rounded-lg outline-none transition-colors bg-background
          text-foreground
      ...
      <label
        ...
        className={`absolute left-4 transition-all duration-200 pointer-events-none
          ${
            isFloating
              ? "top-0 -translate-y-1/2 text-xs bg-background px-1 text-blue-600"
    ...
    <div className="relative">
      <textarea
        ...
        className="w-full px-4 py-3 border border-border
          rounded-lg resize-none bg-background
          text-foreground"
        rows={4}
      />
      <motion.span
